...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/08/25 14:18:24 by mdelwaul          #+#    #+#             */
/*   Updated: 2020/08/27 19:27:37 by marina           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../printf.h"

static int		size_number(unsigned short number, t_param *p)
{
	int	i;
...
static	void	print_number(unsigned short number, t_param *p)
{
	unsigned int	div;
	int				i;
...
void			h_print_unsigned(unsigned short number, t_param *p)
{
	int	i;
