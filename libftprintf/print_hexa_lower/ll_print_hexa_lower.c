...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   ll_print_hexa_lower.c                              :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: marina <marina@student.42.fr>              +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/08/25 13:41:50 by mdelwaul          #+#    #+#             */
/*   Updated: 2020/08/27 19:25:32 by marina           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			ll_print_hexa_lower(long long unsigned int number, t_param *p)
{
	int	i;
