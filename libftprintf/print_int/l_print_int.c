...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/08/25 13:50:41 by mdelwaul          #+#    #+#             */
/*   Updated: 2020/08/28 15:47:29 by marina           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../printf.h"

static int		size_number(long unsigned int integer, t_param *p)
{
	int	i;
...
void			l_print_int(long int integ, t_param *p)
{
	...
	i = 0;
	integer = (long unsigned int)(integ < 0 ? integ * -1 : integ);
